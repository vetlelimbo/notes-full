...
export default function SignupPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full bg-zinc-950 border border-zinc-800 hover:border-zinc-700 p-6 rounded-lg">
      ...
      <form action={handleSubmit}>
        ...
        ></input>
        <div className="h-px bg-zinc-800 mt-10 mb-5"></div>
        <label className="text-zinc-500 block mb-3 text-lg" htmlFor="password">
          Password:
        </label>
        <input
          id="password"
